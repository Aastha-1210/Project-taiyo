...
<h2 className="bg-primary p-3 text-white">Contact Page</h2>
        ...
        <div id="contact_page_div">
          ...
          {flag ? <></> : <Button marginTop={"20px"} onClick={onOpen} className='btn btn-primary '>Create Contact</Button>}
               <Box>
                {
                    flag?
                    <form onSubmit={handleSubmit} id="form" className='card'>
                  <Heading onClick={onClose} className='text-danger'><span className='text-primary'>Add Contact</span><button className='btn btn-danger ml-3'>X</button> </Heading>
                  ...
                  <input type="submit" className='btn btn-primary' value="Save Contact"/>
                    </form>:<></>
                }
               </Box>
