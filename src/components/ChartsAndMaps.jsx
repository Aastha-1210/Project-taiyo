...
const customIcon = L.icon({
  iconUrl: 'https://img.icons8.com/?size=100&id=aXqSmqDrRquU&format=png&color=000000', // Path to the transparent image
  iconSize: [25, 41], // Adjust the size if necessary
